        ...
        <div class="min-h-screen bg-gray-50 py-12">
            <div class="max-w-6xl mx-auto px-4">
                ...
                <div class="flex gap-3 mb-8 flex-wrap">
                    ...
                    <button
                        @click="router.get('/orders?status=pending')"
                        class="px-5 py-2 rounded-xl border"
                    >
                        Pending
                    </button>
                    ...
                    <button
                        @click="router.get('/orders?status=paid')"
                        class="px-5 py-2 rounded-xl border"
                    >
                        Paid
                    </button>
                    ...
                    <button
                        @click="router.get('/orders?status=shipped')"
                        class="px-5 py-2 rounded-xl border"
                    >
                        Shipped
                    </button>
                    ...
                    <button
                        @click="router.get('/orders?status=delivered')"
                        class="px-5 py-2 rounded-xl border"
                    >
                        Delivered
                    </button>
                    ...
                    <button
                        @click="router.get('/orders?status=cancelled')"
                        class="px-5 py-2 rounded-xl border"
                    >
                        Cancelled
                    </button>
                ...
                >
                    ...
                    <!-- CANCEL BUTTON -->
                    <div v-if="order.status === 'pending'" class="mt-5">
                        <button
